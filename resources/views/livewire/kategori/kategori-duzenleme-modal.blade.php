<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
        <h2 class="text-lg font-semibold mb-4">Kategori Düzenle</h2>
        <form wire:submit.prevent="save">
            ...
            <div class="mb-4">
                <label for="edit-is_active" class="block text-sm font-medium text-gray-700">Is Active</label>
                <input type="checkbox" wire:model.defer="is_active" id="edit-is_active" class="mt-1 block w-full border border-gray-300 rounded-md p-2" />
