<flux:modal :name="'duzenle-mahalle-'.$mahalle->id" class="md:w-96">
    <div class="space-y-6">
        <div>
            <flux:heading size="lg">Mahalle Bilgilerini Düzenle</flux:heading>
            <flux:text class="mt-2">Mahalle bilgilerini güncelleyebilirsiniz.</flux:text>
        </div>

        <form wire:submit.prevent="updateMahalle" class="space-y-4">
            <!-- Şehir Seçimi -->
            <!-- Şehir Seçimi -->
            ...
            <div class="flex justify-end space-x-2">
                ...
                <flux:button type="submit" variant="primary">Güncelle</flux:button>
            </div>
        </form>
    </div>
</flux:modal>
